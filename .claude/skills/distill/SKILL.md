...
Reduce the artifact to what is load-bearing. Cut repetition, merge overlapping
threads, and surface the strongest form of each claim. Nothing changes kind —
a distilled Framing is still a Framing, a distilled Phase is still a Phase,
just sharper. Depth-free and safe to re-run.
