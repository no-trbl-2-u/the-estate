...
Assemble the export from `templates/seed.md`. A Seed typechecks only when all
five components are present (see `system/TYPES.md`): Horizon, Trajectory,
first actionable step, at least one refusal, and the provenance stamp
