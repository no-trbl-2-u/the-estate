...
You own the verb(s): **relate, survey** (`.claude/skills/<verb>/SKILL.md`).

## Your work

For `relate`: record the connection between two records and, above all, **why**
— the why is the payload. This is the only hand-authored edge in the system and
the one no machinery can produce.
