---
id: idea-0003/artifacts/0001-martial-havoc-mobile-edition-spark.md
type: Spark
shape: prose
lenses: []
produced-by: capture
...
summary: "A mobile game version of Martial Havoc (Gianluca Monaco's rule-light d6 solo wuxia RPG, CC BY-SA 4.0): the phone as sheet, dice, oracle and Game Master, the full mechanics implemented, shipping The 5 Treasures as its first adventure. Two PDFs are the rules; platform, first-release scope and the narration model are open."
---

# Spark: Martial Havoc, mobile edition
